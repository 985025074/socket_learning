...
DEFUALT_TARGET = hserver hclient file_client file_server select_exp IOreuse_server IOreuse_client oob_client oob_server multi_udp_client multi_udp_server\
half_close_server half_close_client
...
oob_exp: oob_client oob_server
half_close_exp_1: half_close_client half_close_server
